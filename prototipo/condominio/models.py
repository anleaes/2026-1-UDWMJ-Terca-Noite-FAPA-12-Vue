...
class Usuario(models.Model):
    ...
    class Meta:
        abstract = True  # Injeta os campos direto nas classes

class AreaComum(models.Model):  # <-- O correto é apenas models.Model
    ...
    class Meta:
        abstract = True  # Injeta os campos direto nas classes herdantes 
...
# ==========================================
# ÁREAS COMUNS (HERDANDO DE AREACOMUM)
# ==========================================
...
# ==========================================
# RELACIONAMENTOS MANY-TO-MANY REAIS
# ==========================================
